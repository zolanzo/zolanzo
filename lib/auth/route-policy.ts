...
export const ROUTE_RULES: readonly RouteRule[] = [
  ...
  { prefix: "/submissions", access: "authenticated" },
  { prefix: "/welcome", access: "authenticated" },
  ...
  { prefix: "/api/contact", access: "public" },
