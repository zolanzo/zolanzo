...
export function SocialLoginButtons({ onSocialLogin }: SocialLoginButtonsProps) {
  ...
  const buttonClasses =
    "w-full h-[46px] rounded-xl border border-slate-300 dark:border-white/[0.08] bg-slate-100/80 dark:bg-zinc-900/80 hover:bg-slate-200/90 dark:hover:bg-zinc-800/90 text-slate-800 dark:text-zinc-200 font-semibold text-xs transition-all duration-200 flex items-center justify-center gap-3 cursor-pointer group";
