  ...
  return (
    <div className="space-y-2.5 w-full">
      ...
      <button
        ...
        className="w-full h-[46px] rounded-xl border border-zinc-800 bg-zinc-900/80 hover:bg-zinc-800/90 text-zinc-200 font-semibold text-xs transition-all duration-200 flex items-center justify-center gap-3 cursor-pointer group"
      >
