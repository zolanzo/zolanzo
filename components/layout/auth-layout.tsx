...
/**
 * Centered authentication layout — monochrome mark on dark surfaces.
 */
      ...
      <main className="relative z-10 flex flex-1 items-center justify-center px-4 py-10">
        <div className="border-border bg-card shadow-floating w-full max-w-md rounded-2xl border p-6 sm:p-8">
          <div className="mb-6 flex flex-col items-center text-center">
            <BrandLogo asset="monochrome" width={48} height={48} className="mb-4 opacity-90 dark:opacity-100" />
            {title ? <h1 className="text-h3">{title}</h1> : null}
            {subtitle ? (
