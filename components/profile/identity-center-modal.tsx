...
export function IdentityCenterModal({ isOpen, onClose }: IdentityCenterModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-overlay backdrop-blur-sm animate-fadeIn">
      <div className="w-full max-w-[520px] bg-card border border-border rounded-3xl p-6 shadow-2xl relative text-foreground space-y-5 max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">Verify your identity to unlock higher payout limits and premium opportunities.</p>
        </div>
        ...
        <div className="space-y-2 text-xs">
          ...
          <div className="p-3 rounded-xl bg-card border border-border flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-foreground">Phone OTP Verification</span>
            </div>
            <span className="text-primary font-bold flex items-center gap-1">
              <HugeiconsIcon icon={CheckmarkBadge01Icon} size={14} /> Verified
            </span>
          ...
          <div className="p-3 rounded-xl bg-card border border-border flex items-center justify-between">
            <div className="flex items-center gap-2">
              <HugeiconsIcon icon={File01Icon} size={16} className="text-warning" />
              <span className="font-bold text-foreground">National Identity Number (NIN)</span>
            </div>
            <span className="text-warning font-bold">Action Required</span>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmitNIN} className="space-y-4 text-left">
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-muted-foreground">11-Digit NIN Number</label>
            <input
              type="text"
              required
              value={nin}
          ...
          <button
            ...
            className="w-full h-[48px] rounded-xl bg-primary hover:bg-primary-hover text-primary-foreground font-bold text-xs transition-all flex items-center justify-center cursor-pointer disabled:opacity-50 shadow-md"
          >
