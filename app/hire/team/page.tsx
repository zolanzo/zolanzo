...
export default function TeamManagementPage() {
  ...
  const [members, setMembers] = useState<TeamMember[]>([
    { id: "tm_1", name: "Amina Aliyu", email: "amina@kora-ai.example.com", role: "Owner", status: "Active" },
    { id: "tm_2", name: "Samuel Kalu", email: "samuel@kora-ai.example.com", role: "Campaign Manager", status: "Active" },
    { id: "tm_3", name: "Tunde Bakare", email: "tunde@kora-ai.example.com", role: "Finance", status: "Active" },
    { id: "tm_4", name: "Kemi Adeleke", email: "kemi@kora-ai.example.com", role: "Reviewer", status: "Pending Invite" },
  ]);
    ...
    <AppShell userName="Amina" avatarUrl="/brand/lady1.png">
      ...
      {inviteModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fadeIn">
          <div className="w-full max-w-[440px] bg-[#0A0F12] border border-white/10 rounded-3xl p-6 space-y-5 shadow-2xl relative text-white">
            <button
              type="button"
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-zinc-400">Grant permission-based access to your corporate employer workspace.</p>
            </div>
            ...
            <form onSubmit={handleInviteSubmit} className="space-y-4 text-left">
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-zinc-300">Role & Permissions</label>
                <select
                  value={selectedRole}
                ...
                >
                  ...
                  <option value="Finance">Finance (Wallet & Withdrawals)</option>
              ...
              <button
                type="submit"
                className="w-full h-[48px] rounded-xl bg-purple-600 hover:bg-purple-700 text-white font-bold text-xs transition-all cursor-pointer shadow-md"
              >
                Send Invite Email
              </button>
            </form>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-white/10">
          <div>
            ...
            <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed mt-1">
              Invite team members, assign role-based access control, and audit workspace actions.
            </p>
          </div>
          ...
          <button
            ...
            className="h-[44px] px-5 rounded-xl bg-purple-600 hover:bg-purple-700 text-white font-bold text-xs flex items-center justify-center gap-2 transition-all shadow-md shrink-0 cursor-pointer"
          >
              ...
              <tbody className="divide-y divide-zinc-800/60">
                {members.map((m) => (
                  <tr key={m.id} className="hover:bg-zinc-900/40 transition-colors">
                    ...
                    <td className="p-4 text-zinc-300 font-mono">{m.email}</td>
                    <td className="p-4">
